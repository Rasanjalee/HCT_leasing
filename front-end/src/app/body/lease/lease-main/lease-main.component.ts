...
export class LeaseMainComponent implements OnInit {
  ...
  payInstallment() {
    ...
    //   if (this.selectedLease.leaseMaster.leaseTypeKey === 3) {
    //     this.leaseInstallmentAmounts.installment = this.payingAmountInLinearPayment;
    //   }
    //   this.leaseService.payMonthlyInstallment(this.selectedLeaseId, this.leaseInstallmentAmounts.interest,
    //     this.installmentPaidEffectiveDate, 13, this.leaseInstallmentAmounts.installment,
    //     this.leaseInstallmentAmounts.outDatedDaysCount, this.leaseInstallmentAmounts.penaltyAmount)
    //     .subscribe( (data: any) => {
  ...
  checkValidation() {
    if (this.selectedLease.leaseMaster.leaseTypeKey === 3) {
      console.log(this.payingAmountInLinearPayment)
      console.log(Number(this.leaseInstallmentAmounts.installment.toFixed(2)))
